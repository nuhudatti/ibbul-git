    ...
    <AnimatePresence>
      {isOpen ? (
        <motion.aside
          ...
          className="fixed inset-x-0 bottom-0 z-50 h-[70vh] max-h-[calc(100vh-80px)] rounded-t-3xl border border-white/10 bg-[#0a0a0f] shadow-2xl overflow-hidden sm:relative sm:inset-auto sm:h-full sm:max-h-none sm:rounded-none sm:border-l sm:w-80"
        >
